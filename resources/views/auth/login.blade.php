...
<form action="{{ route('login') }}" class="sign__form" method="POST">
    ...
    <span class="sign__text">Not have an account? <a href="{{ route('register')}}">Sign up now</a></span>
    <span class="sign__text">Not remember password ?
     <a href="{{ route('password.request')}}">reset now</a></span>
</form>
@endsection